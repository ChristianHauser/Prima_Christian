...
(function (Test_sprites) {
    ...
    async function hndLoad(_event) {
        ...
        await imgSpriteSheet.load("Projekt1\Images/MarioJump1.png");
        let coat = new ƒ.CoatTextured(undefined, imgSpriteSheet);
        let animation = new ƒAid.SpriteSheetAnimation("JUmpTest", coat);
        animation.generateByGrid(ƒ.Rectangle.GET(1, 0, 17, 60), 8, 22, ƒ.ORIGIN2D.BOTTOMCENTER, ƒ.Vector2.X(20));
        spriteNode = new ƒAid.NodeSprite("JUmpTest");
